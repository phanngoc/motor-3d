...
export const SYSTEMS = [
  ...
  },
  {
    ...
    tagline: 'Chuyển động piston KHÔNG đối xứng — nửa trên nhanh hơn nửa dưới.',
  ...
  },
  {
    ...
    tagline: 'Trục khuỷu RỜI. Máy một xy-lanh không thể cân bằng hết — có số chứng minh.',
  ...
  },
  {
    ...
    tagline: 'Bộ hoà khí CV: van trượt đi theo lưu lượng khí, ba mạch xăng chuyển giao nhau.',
    tags: ['van trượt CV', 'gíc-lơ #75/#35', 'chẩn theo dải ga'],
  },
  {
    ix: '08', slug: 'ignition-electric', status: '3d',
    name: 'Đánh lửa & hệ thống điện',
    nameEn: 'Ignition & electrical system',
    tagline: 'Góc sớm suy ra từ hai sự thật vật lý. Điện áp phóng tia phụ thuộc ÁP SUẤT.',
  ...
  },
  {
    ...
    tagline: 'Phanh là bài toán CHUYỂN TẢI. Tang trống là hộp kín nên đổ đèo là mất phanh.',
